# Parity battery run 20260918T112949Z
...
- [f13_ctrlc_exit/behavior] ts: C-c C-c exits in 0.15s (case healthy, resume hint after exit)
- [f13_ctrlc_exit/behavior] rust: C-c C-c exits in 0.05s (case healthy, exit code 0)
