# Parity battery run 20260918T231155Z
...
0 gaps, 47 EXPECTED-FAIL (known gaps, owner lanes), 23 parity checks passed.
...
- [f16_refine/visual] EXPECTED-FAIL (lane: decorations-3): ts: no '◆ Harness refined' outcome row after the kernel-scheduled refinement — evidence: ts/f16_refine/02-refine-settled.txt
...
- [f18_goal_autonomous/visual] EXPECTED-FAIL (lane: goal-autonomous): ts: goal.complete() produced no visible completion row — evidence: ts/f18_goal_autonomous/05-goal-complete.txt
- [f18_goal_autonomous/visual] EXPECTED-FAIL (lane: goal-autonomous): rust: /goal pause produced no visible paused row — evidence: rust/f18_goal_autonomous/03-goal-pause.txt
...
- [f21_worker_recovery/protocol] rust: recovery respawned the worker (pid 104143 -> 104304, workerState ready)
