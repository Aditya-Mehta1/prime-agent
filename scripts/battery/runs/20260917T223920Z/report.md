# Parity battery run 20260917T223920Z
...
- [f5_side_questions/protocol] post-turn status-line request issued by both sides (ts=6, rust=2 requests, model qwen/qwen3-30b-a3b-instruct-2507)
...
- [f7_compaction/protocol] ts: daemon 'compact' succeeded: {"summary": "pre-compaction reply 6", "firstKeptEntryId": "68102c75", "tokensBefore": 110, "details": {"readFiles": [], "modifiedFiles": []}}
- [f7_compaction/protocol] rust: daemon 'compact' succeeded: {"firstKeptEntryId": "707890a3", "summary": "pre-compaction reply 6", "tokensBefore": 110}
- [f8_resume/behavior] print '-c' refuses a session active in the daemon on both sides: 2fac1120afcb (ts) vs 6d14489a6568 (rust)
...
- [f10_perf/perf] ts: cold startup to interactive-ready median 5.162s over 3 launches (first frame median 5.076s); typing latency median 65.5ms, p95 81.7ms over 75 keystrokes
- [f10_perf/perf] rust: cold startup to interactive-ready median 0.293s over 3 launches (first frame median 0.293s); typing latency median 57.7ms, p95 84.9ms over 75 keystrokes
- [f10_perf/perf] startup: rust 0.293s vs ts 5.162s cold-ready median (ratio 0.06, threshold 1.5)
- [f10_perf/perf] typing: rust p95 84.9ms vs ts p95 81.7ms keystroke-to-render (ratio 1.04, threshold 1.5)
- [f10_perf/perf] rust binary measured: /home/ubuntu/lane-worktrees/fd-leak-audit/target/release/prime-agent (119.7MB, release posture)
