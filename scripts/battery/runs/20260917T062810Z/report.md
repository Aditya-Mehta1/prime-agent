# Parity battery run 20260917T062810Z

- ts binary: prime-agent
- rust binary: /home/ubuntu/lane-worktrees/trial-send-2/target/release/prime-agent
...
0 gaps, 35 parity checks passed.
...
- [f7_compaction/protocol] ts: daemon 'compact' succeeded: {"summary": "pre-compaction reply 6", "firstKeptEntryId": "b517d23d", "tokensBefore": 110, "details": {"readFiles": [], "modifiedFiles": []}}
- [f7_compaction/protocol] rust: daemon 'compact' succeeded: {"firstKeptEntryId": "f28c6a2c", "summary": "pre-compaction reply 6", "tokensBefore": 110}
- [f8_resume/behavior] print '-c' refuses a session active in the daemon on both sides: f75a94cf0208 (ts) vs a5a0d357e36d (rust)
...
- [f10_perf/perf] ts: cold startup to interactive-ready median 2.552s over 3 launches (first frame median 2.510s); typing latency median 16.9ms, p95 40.9ms over 75 keystrokes
- [f10_perf/perf] rust: cold startup to interactive-ready median 0.206s over 3 launches (first frame median 0.206s); typing latency median 21.2ms, p95 48.8ms over 75 keystrokes
- [f10_perf/perf] startup: rust 0.206s vs ts 2.552s cold-ready median (ratio 0.08, threshold 1.5)
- [f10_perf/perf] typing: rust p95 48.8ms vs ts p95 40.9ms keystroke-to-render (ratio 1.19, threshold 1.5)
- [f10_perf/perf] rust binary measured: /home/ubuntu/lane-worktrees/trial-send-2/target/release/prime-agent (102.5MB, release posture)
