# Parity battery run 20260918T045302Z
...
- rust binary: /home/ubuntu/lane-worktrees/streaming-render/target/release/prime-agent
...
- [behavior] ts: 'f9 inactive prompt' is not grouped under the Inactive section (sections: {"Running": ["\u25c7 battery-f9-busy             mock-1                                                                          $0.00   3s"], "Idle": ["\u2022 battery-f9-idle             mock-1                                                                          $0.00  16s", "\u2191/\u2193 navigate   Enter/\u2192 open   Ctrl+N new"]}) — evidence: ts/f9_agents_view/01-agents-view-120x36.txt
...
- [f7_compaction/protocol] ts: daemon 'compact' succeeded: {"summary": "pre-compaction reply 6", "firstKeptEntryId": "26abeb96", "tokensBefore": 110, "details": {"readFiles": [], "modifiedFiles": []}}
- [f7_compaction/protocol] rust: daemon 'compact' succeeded: {"firstKeptEntryId": "ac10c8a1", "summary": "pre-compaction reply 6", "tokensBefore": 110}
- [f8_resume/behavior] print '-c' refuses a session active in the daemon on both sides: 62cbcefe8831 (ts) vs 6d46f8f08a53 (rust)
...
- [f10_perf/perf] ts: cold startup to interactive-ready median 10.367s over 3 launches (first frame median 10.276s); typing latency median 95.3ms, p95 161.4ms over 75 keystrokes
- [f10_perf/perf] rust: cold startup to interactive-ready median 0.399s over 3 launches (first frame median 0.399s); typing latency median 92.4ms, p95 150.8ms over 75 keystrokes
- [f10_perf/perf] startup: rust 0.399s vs ts 10.367s cold-ready median (ratio 0.04, threshold 1.5)
- [f10_perf/perf] typing: rust p95 150.8ms vs ts p95 161.4ms keystroke-to-render (ratio 0.93, threshold 1.5)
- [f10_perf/perf] rust binary measured: /home/ubuntu/lane-worktrees/streaming-render/target/release/prime-agent (124.5MB, release posture)
