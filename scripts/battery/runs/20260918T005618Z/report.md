# Parity battery run 20260918T005618Z
...
0 gaps, 40 parity checks passed.
...
- [f7_compaction/protocol] ts: daemon 'compact' succeeded: {"summary": "pre-compaction reply 6", "firstKeptEntryId": "6d8a7851", "tokensBefore": 110, "details": {"readFiles": [], "modifiedFiles": []}}
- [f7_compaction/protocol] rust: daemon 'compact' succeeded: {"firstKeptEntryId": "95726d19", "summary": "pre-compaction reply 6", "tokensBefore": 110}
- [f8_resume/behavior] print '-c' refuses a session active in the daemon on both sides: ac33c358f1f1 (ts) vs 2803a24c88c6 (rust)
...
- [f10_perf/perf] ts: cold startup to interactive-ready median 6.099s over 3 launches (first frame median 5.999s); typing latency median 59.6ms, p95 96.9ms over 75 keystrokes
- [f10_perf/perf] rust: cold startup to interactive-ready median 0.375s over 3 launches (first frame median 0.375s); typing latency median 50.8ms, p95 83.4ms over 75 keystrokes
- [f10_perf/perf] startup: rust 0.375s vs ts 6.099s cold-ready median (ratio 0.06, threshold 1.5)
- [f10_perf/perf] typing: rust p95 83.4ms vs ts p95 96.9ms keystroke-to-render (ratio 0.86, threshold 1.5)
