# Parity battery run 20260917T134930Z
...
- rust binary: /home/ubuntu/lane-worktrees/mcp-execution/target/release/prime-agent
...
- [f7_compaction/protocol] ts: daemon 'compact' succeeded: {"summary": "pre-compaction reply 6", "firstKeptEntryId": "c50582be", "tokensBefore": 110, "details": {"readFiles": [], "modifiedFiles": []}}
- [f7_compaction/protocol] rust: daemon 'compact' succeeded: {"firstKeptEntryId": "24d5cfcb", "summary": "pre-compaction reply 6", "tokensBefore": 110}
- [f8_resume/behavior] print '-c' refuses a session active in the daemon on both sides: 5c85d1b4cda0 (ts) vs 7781f853e64d (rust)
...
- [f10_perf/perf] ts: cold startup to interactive-ready median 0.837s over 3 launches (first frame median 0.822s); typing latency median 6.3ms, p95 14.4ms over 75 keystrokes
- [f10_perf/perf] rust: cold startup to interactive-ready median 0.138s over 3 launches (first frame median 0.138s); typing latency median 5.8ms, p95 6.2ms over 75 keystrokes
- [f10_perf/perf] startup: rust 0.138s vs ts 0.837s cold-ready median (ratio 0.16, threshold 1.5)
- [f10_perf/perf] typing: rust p95 6.2ms vs ts p95 14.4ms keystroke-to-render (ratio 0.43, threshold 1.5)
- [f10_perf/perf] rust binary measured: /home/ubuntu/lane-worktrees/mcp-execution/target/release/prime-agent (110.6MB, release posture)
