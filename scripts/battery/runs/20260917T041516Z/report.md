# Parity battery run 20260917T041516Z

- ts binary: prime-agent
- rust binary: /home/ubuntu/lane-worktrees/thin3/target/release/prime-agent
- flows: f1_launch, f2_prompt, f3_tool, f4_commands, f5_side_questions, f6_attach, f7_compaction, f8_resume, f9_agents_view

## Findings

4 gaps, 23 parity checks passed.
...
- [protocol] session entry types differ: ts-only=['service_tier_change'] rust-only=['custom']; full counts in f8_resume-session-shapes.json — evidence: f8_resume-session-shapes.json
...
- [f7_compaction/protocol] ts: daemon 'compact' succeeded: {"summary": "pre-compaction reply 6", "firstKeptEntryId": "983c921c", "tokensBefore": 110, "details": {"readFiles": [], "modifiedFiles": []}}
- [f7_compaction/protocol] rust: daemon 'compact' succeeded: {"firstKeptEntryId": "5f4783b5", "summary": "pre-compaction reply 6", "tokensBefore": 110}
- [f8_resume/behavior] print '-c' refuses a session active in the daemon on both sides: 5c78445d0f4c (ts) vs 706e7cb2d937 (rust)
