# Parity battery run 20260917T120739Z
...
- [f7_compaction/protocol] ts: daemon 'compact' succeeded: {"summary": "pre-compaction reply 6", "firstKeptEntryId": "16183455", "tokensBefore": 110, "details": {"readFiles": [], "modifiedFiles": []}}
- [f7_compaction/protocol] rust: daemon 'compact' succeeded: {"firstKeptEntryId": "2e9b846b", "summary": "pre-compaction reply 6", "tokensBefore": 110}
- [f8_resume/behavior] print '-c' refuses a session active in the daemon on both sides: 9382442ee1de (ts) vs 8c19a3b6ee0c (rust)
...
- [f10_perf/perf] ts: cold startup to interactive-ready median 0.978s over 3 launches (first frame median 0.966s); typing latency median 7.3ms, p95 18.7ms over 75 keystrokes
- [f10_perf/perf] rust: cold startup to interactive-ready median 0.134s over 3 launches (first frame median 0.134s); typing latency median 6.4ms, p95 10.3ms over 75 keystrokes
- [f10_perf/perf] startup: rust 0.134s vs ts 0.978s cold-ready median (ratio 0.14, threshold 1.5)
- [f10_perf/perf] typing: rust p95 10.3ms vs ts p95 18.7ms keystroke-to-render (ratio 0.55, threshold 1.5)
- [f10_perf/perf] rust binary measured: /home/ubuntu/lane-worktrees/agents-view/target/release/prime-agent (106.8MB, release posture)
