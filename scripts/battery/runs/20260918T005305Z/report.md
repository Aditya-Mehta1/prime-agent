# Parity battery run 20260918T005305Z
...
- rust binary: /home/ubuntu/lane-worktrees/onboarding-parity/target/release/prime-agent
...
- [f7_compaction/protocol] ts: daemon 'compact' succeeded: {"summary": "pre-compaction reply 6", "firstKeptEntryId": "f0e699eb", "tokensBefore": 110, "details": {"readFiles": [], "modifiedFiles": []}}
- [f7_compaction/protocol] rust: daemon 'compact' succeeded: {"firstKeptEntryId": "505f0165", "summary": "pre-compaction reply 6", "tokensBefore": 110}
- [f8_resume/behavior] print '-c' refuses a session active in the daemon on both sides: 945aeef43489 (ts) vs 0420b848ee1a (rust)
...
- [f10_perf/perf] ts: cold startup to interactive-ready median 4.938s over 3 launches (first frame median 4.895s); typing latency median 57.1ms, p95 91.9ms over 75 keystrokes
- [f10_perf/perf] rust: cold startup to interactive-ready median 0.318s over 3 launches (first frame median 0.318s); typing latency median 55.0ms, p95 76.3ms over 75 keystrokes
- [f10_perf/perf] startup: rust 0.318s vs ts 4.938s cold-ready median (ratio 0.06, threshold 1.5)
- [f10_perf/perf] typing: rust p95 76.3ms vs ts p95 91.9ms keystroke-to-render (ratio 0.83, threshold 1.5)
- [f10_perf/perf] rust binary measured: /home/ubuntu/lane-worktrees/onboarding-parity/target/release/prime-agent (119.8MB, release posture)
