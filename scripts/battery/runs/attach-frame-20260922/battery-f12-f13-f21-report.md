# Parity battery run 20260922T075517Z
...
- flows: f12_scroll, f13_ctrlc_exit, f21_worker_recovery

## Findings

0 gaps, 4 EXPECTED-FAIL (known gaps, owner lanes), 15 parity checks passed.
...
- [f13_ctrlc_exit/behavior] ts: C-c C-c exits in 0.17s (case healthy, exit code 0)
- [f13_ctrlc_exit/behavior] rust: C-c C-c exits in 0.39s (case healthy, exit code 0)
- [f13_ctrlc_exit/behavior] rust: C-c C-c exits in 0.98s (case wedged, exit code 0)
- [f13_ctrlc_exit/behavior] rust: C-c C-c exits in 0.44s (case daemon_dead, exit code 0)
...
- [f21_worker_recovery/protocol] rust: recovery respawned the worker (pid 4083121 -> 4084011, workerState ready)
