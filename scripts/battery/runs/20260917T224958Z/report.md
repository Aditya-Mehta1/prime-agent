# Parity battery run 20260917T224958Z
...
- rust binary: /home/ubuntu/lane-worktrees/branding-scrub/target/release/prime-agent
...
1 gaps, 38 parity checks passed.
...
- [f7_compaction/protocol] ts: daemon 'compact' succeeded: {"summary": "pre-compaction reply 6", "firstKeptEntryId": "f1128d60", "tokensBefore": 110, "details": {"readFiles": [], "modifiedFiles": []}}
- [f7_compaction/protocol] rust: daemon 'compact' succeeded: {"firstKeptEntryId": "8d457304", "summary": "pre-compaction reply 6", "tokensBefore": 110}
- [f8_resume/behavior] print '-c' refuses a session active in the daemon on both sides: 592f96c3b73c (ts) vs 32a300b3b2bc (rust)
...
- [f10_perf/perf] ts: cold startup to interactive-ready median 6.754s over 3 launches (first frame median 6.702s); typing latency median 60.4ms, p95 102.0ms over 75 keystrokes
- [f10_perf/perf] rust: cold startup to interactive-ready median 0.312s over 3 launches (first frame median 0.312s); typing latency median 53.1ms, p95 75.4ms over 75 keystrokes
- [f10_perf/perf] startup: rust 0.312s vs ts 6.754s cold-ready median (ratio 0.05, threshold 1.5)
- [f10_perf/perf] typing: rust p95 75.4ms vs ts p95 102.0ms keystroke-to-render (ratio 0.74, threshold 1.5)
- [f10_perf/perf] rust binary measured: /home/ubuntu/lane-worktrees/branding-scrub/target/release/prime-agent (119.5MB, release posture)
