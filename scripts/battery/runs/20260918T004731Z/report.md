# Parity battery run 20260918T004731Z
...
- rust binary: /home/ubuntu/lane-worktrees/kernel-packaging/target/release/prime-agent
...
- [f7_compaction/protocol] ts: daemon 'compact' succeeded: {"summary": "pre-compaction reply 6", "firstKeptEntryId": "f8d7332e", "tokensBefore": 110, "details": {"readFiles": [], "modifiedFiles": []}}
- [f7_compaction/protocol] rust: daemon 'compact' succeeded: {"firstKeptEntryId": "e4779ecb", "summary": "pre-compaction reply 6", "tokensBefore": 110}
- [f8_resume/behavior] print '-c' refuses a session active in the daemon on both sides: e29febc15187 (ts) vs 0954a6aa8a4e (rust)
...
- [f10_perf/perf] ts: cold startup to interactive-ready median 6.971s over 3 launches (first frame median 6.910s); typing latency median 69.2ms, p95 96.8ms over 75 keystrokes
- [f10_perf/perf] rust: cold startup to interactive-ready median 0.334s over 3 launches (first frame median 0.334s); typing latency median 66.7ms, p95 95.4ms over 75 keystrokes
- [f10_perf/perf] startup: rust 0.334s vs ts 6.971s cold-ready median (ratio 0.05, threshold 1.5)
- [f10_perf/perf] typing: rust p95 95.4ms vs ts p95 96.8ms keystroke-to-render (ratio 0.99, threshold 1.5)
- [f10_perf/perf] rust binary measured: /home/ubuntu/lane-worktrees/kernel-packaging/target/release/prime-agent (120.5MB, release posture)
