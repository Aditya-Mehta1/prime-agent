...
impl SessionEngine for ScriptedEngine {
    ...
    fn run_prompt(
        ...
        // accumulated message set — the accepted row, the final assistant
        // message, and every tool result in the scripted shape.
        let mut run_messages = vec![accepted_row, final_message];
