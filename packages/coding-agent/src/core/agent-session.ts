...
import { createToolIntentRecoveryMessage, isToolIntentStop } from "./tool-intent-recovery.js";
...
export class AgentSession {
	...
	private _installAgentToolIntentRecoveryHook(): void {
		this.agent.getToolIntentRecovery = (context) => {
			...
			return isToolIntentStop(context.message) ? createToolIntentRecoveryMessage() : undefined;
		};
	}
